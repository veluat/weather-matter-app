          ...
          >
            ...
            {selectedIndex === index && (
              <>
                ...
                {index === 1 && <li className={`${s.value} ${selectedIndex === index ? s.active : ''}`}>{data[locale].label[1]}</li>}
                {index === 2 && <li className={`${s.value} ${selectedIndex === index ? s.active : ''}`}>{data[locale].label[2]}</li>}
                {index === 3 && <li className={`${s.value} ${selectedIndex === index ? s.active : ''}`}>{data[locale].label[3]}</li>}
              </>
            )}
          </ul>
        )
